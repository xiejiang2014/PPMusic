...
namespace PPMusic
{
    ...
    internal class FakeDataCreator
    {
            ...
            yield return new Album()
                         {
                             ...
                             Songs         = new ObservableCollection<Song>(GetRandomSongs(3))
                         };
            ...
            yield return new Album()
                         {
                             ...
                             Description   = "《平行世界》 我最后的信念，是与你在平行世界再相遇。 G.E.M. 邓紫棋2021年首支全创作单曲《平行世界》，唱出虽痛失所爱却为爱坚持的信念。", Songs = new ObservableCollection<Song>(GetRandomSongs(3))
                         };
        ...
        {
            return GetRandomWaveFiles().Select(v => new Song()
                                                    {
                                                        AudioFile = v
                                                    }
                                              );
        ...
        private IEnumerable<string> _mp3Files;
